...
comandss = ["start", "settings", "info", "shazam", "help_me"]
...
share_message = "tg://msg?text=Start @%s for download all the songs which you want ;)"
...
help_message = (
	...
	"\n\n/shazam: Identify a song by a voice or audio message (You can't do without calling this command, just send the media)" +
